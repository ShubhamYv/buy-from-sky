...
import com.sky.modal.Order;
import com.sky.repository.OrderRepository;
import com.sky.response.ApiResponse;
import com.sky.response.PaymentLinkResponse;
import com.sky.service.OrderService;
import com.sky.service.UserService;
import com.sky.user.domain.OrderStatus;
import com.sky.user.domain.PaymentStatus;
...
public class PaymentController {
	...
	public ResponseEntity<PaymentLinkResponse> createPaymentLink(@PathVariable Long orderId,
		...
		try {
			...
			RazorpayClient razorpay = new RazorpayClient("rzp_test_7DEvvvuXPnBOEV", "L595HYj47lEkbf");
			...
			paymentLinkRequest.put("callback_url", "https://skykart.vercel.app/payment" + orderId);
...
//		order_id
	...
	public ResponseEntity<ApiResponse> redirect(@RequestParam(name = "payment_id") String paymentId,
		...
		try {
			...
			new RedirectView("https://skykart.vercel.app/payment/failed");
			throw new RazorpayException(e.getMessage());
		}
